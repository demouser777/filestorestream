...
# Subscribe YouTube Channel For Amazing Bot https://telegram.me/sdmoviesflixofficial
...
from config import Var, LOG_CHANNEL, PICS, BATCH_FILE_CAPTION, CUSTOM_FILE_CAPTION, AUTO_DELETE_TIME, AUTO_DELETE, ADMINS, GRP_LINK
import re
import json
import base64
...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('💝 𝙱𝚊𝚌𝚔𝚞𝚙 𝙲𝚑𝚊𝚗𝚗𝚎𝚕 💝', url='https://telegram.me/sdmoviesflixofficial')
            ],[
            InlineKeyboardButton('🔍 𝙼𝚘𝚟𝚒𝚎 𝙶𝚛𝚘𝚞𝚙', url='GRP_LINK'),
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/sdmoviesflixnew')
            ],[
...
# Ask Doubt on telegram @KingVJ01
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🔍 𝙼𝚘𝚟𝚒𝚎 𝙶𝚛𝚘𝚞𝚙', url='https://t.me/vj_bot_disscussion'),
